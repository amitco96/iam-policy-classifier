...
export default function ClassifyPage() {
  ...
  return (
    <div className="flex h-full min-h-screen">
      {/* LEFT PANEL */}
      <div className="w-1/2 border-r border-gray-200 p-6 flex flex-col gap-4">
        <h2 className="text-lg font-semibold text-gray-800">Policy Input</h2>

        {/* Textarea */}
        <textarea
          className="w-full flex-1 min-h-[300px] font-mono text-sm border border-gray-300 rounded-md p-3 resize-y focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent placeholder-gray-400"
          placeholder={'{\n  "Version": "2012-10-17",\n  "Statement": [...]\n}'}
          value={policyText}
          onChange={(e) => {
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-colors"
          >
            Upload JSON
          </button>
          {fileName && (
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-indigo-600 text-white text-sm font-semibold rounded-md hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition-colors"
        >
          {isLoading && (
            <svg
